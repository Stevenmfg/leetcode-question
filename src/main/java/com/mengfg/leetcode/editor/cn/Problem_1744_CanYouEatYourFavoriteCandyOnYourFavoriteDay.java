...
class Problem_1744_CanYouEatYourFavoriteCandyOnYourFavoriteDay {
    public static void main(String[] args) {
        Solution solution = new Problem_1744_CanYouEatYourFavoriteCandyOnYourFavoriteDay().new Solution();
    }
